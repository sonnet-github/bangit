            ...
            <div class="homepage-hero__wrap flex items-center flex-space-between">
                ...
                <div class="homepage-hero__left">
                    <div class="homepage-hero__left-inner">
                        ...
                        <?php endif; ?>
                        <div class="homepage-hero__google-rate">
                            <img src="<?=get_template_directory_uri()?>/assets/images/img-google-rate.png" alt="Google Rating">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="homepage-hero__right">
                        <div class="homepage-hero__right-inner">
                            <div class="homepage-hero__right-vector">
                                <?php for($x = 1; $x <= 4; $x++): ?>
                                    <img src="<?=get_template_directory_uri()?>/assets/images/img-vector-<?=$x?>.png" class="vector-image vector-image--<?=$x?>" alt="img-vector-<?=$x?>.png">
                                <?php endfor; ?>
                            </div>
